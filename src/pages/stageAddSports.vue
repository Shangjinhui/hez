<template>
  <div class="container pt50 pb45 flex-top-center">
    <div class="main-out flex-top">
      <my-side></my-side>
      <div class="main rel">
        <p class="fsize18 colfff pt23 lh30 center">添加体育成绩</p>
        <div class="kuang pt25 pl70 pr70 fsize14">
          ...
          <div class="flex-btm mb10">
            <div class="flex wid420">
              <p class="lh40">
                <span class="wid75 inline justify">50米</span>：
              </p>
              <input
            ...
            <div class="flex">
              <p class="lh40">
                <span class="wid75 inline justify">立定跳远</span>：
              </p>
              <input
                class="input wid285 lh40 pl15 pr15"
                type="text"
          ...
          <div class="flex-btm mb10">
            <div class="flex wid420">
              <p class="lh40">
                <span class="wid75 inline justify">坐位体前屈</span>：
              </p>
              <input
                class="input wid285 lh40 pl15 pr15"
                type="text"
                v-model="sittingForward"
                :disabled="handle == 2"
              />
            </div>
            <div class="flex">
              <p class="lh40">
                <span class="wid75 inline justify">800米跑</span>：
              </p>
              <input
                class="input wid285 lh40 pl15 pr15"
                type="text"
                v-model="longDistanceRunFemale"
                :disabled="handle == 2"
              />
            </div>
          </div>
          <div class="flex-btm mb10">
            <div class="flex wid420">
              <p class="lh40">
                <span class="wid75 inline justify">1000米跑</span>：
              </p>
              <input
                class="input wid285 lh40 pl15 pr15"
                type="text"
                v-model="longDistanceRunMale"
                :disabled="handle == 2"
              />
            </div>
            <div class="flex">
              <p class="lh40">
                <span class="wid75 inline justify">仰卧起坐</span>：
              </p>
              <input
                class="input wid285 lh40 pl15 pr15"
                type="text"
          ...
          <div class="flex-btm mb10">
            <div class="flex wid420">
              <p class="lh40">
                <span class="wid75 inline justify">引体向上</span>：
              </p>
              <input
                class="input wid285 lh40 pl15 pr15"
                type="text"
    ...
    methods:{
        getData(){
            this.$fetch({
                ...
                if(res.flag){
                    ...
                    this.runFifty = res.data.runFifty;
                    this.jump = res.data.jump;
                    this.sittingForward = res.data.sittingForward;
                    this.longDistanceRunFemale = res.data.longDistanceRunFemale;
                    this.longDistanceRunMale = res.data.longDistanceRunMale;
                    this.sitUp = res.data.sitUp;
                    this.pullUp = res.data.pullUp;
                }
            })
        },
        changeDate(val){
        ...
        Confirm(){
            ...
            let params = {
                id:this.id,
                timer:this.timer,
                runFifty:this.runFifty,
                jump:this.jump,
                sittingForward:this.sittingForward,
                longDistanceRunFemale:this.longDistanceRunFemale,
                longDistanceRunMale:this.longDistanceRunMale,
                sitUp:this.sitUp,
                pullUp:this.pullUp,
            }
            // console.log(params);
